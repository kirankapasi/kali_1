...
const LoginPage = () => {
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="text-2xl font-bold mb-6 text-neutral-900">Welcome back</h2>
      ...
      <div className="mt-6">
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full flex justify-center items-center py-2 px-4 border border-neutral-300 rounded-md shadow-sm bg-white text-neutral-700 hover:bg-neutral-50"
            disabled={loading}
          >
      ...
      <p className="mt-8 text-center text-sm text-neutral-600">
        ...
        <Link to="/auth/register" className="font-medium text-primary-600 hover:text-primary-800">
          Sign up
        </Link>
      </p>
    </div>
